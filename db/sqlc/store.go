...
// TransferTxParams contains the input params of the transfer transactions
...
// CCreates a transfer record, adds account entires and updates accounts' balance within a single DB Tx
